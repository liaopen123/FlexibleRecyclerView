 ...
 */
public abstract class SnapHelper1 extends RecyclerView.OnFlingListener {
    ...
    private final RecyclerView.OnScrollListener mScrollListener =
            new RecyclerView.OnScrollListener() {
                ...
                public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                    if (dx != 0 || dy != 0) {
                        mScrolled = true;
                        View snapView = findSnapView(mRecyclerView.getLayoutManager());
                        assert snapView != null;
                        //找个百分比
                        floatX+= dx;
                        Log.e("snapView","百分比floatX:"+floatX);
                        Log.e("snapView","百分比getMeasuredWidth:"+(mRecyclerView.getMeasuredWidth()));
                        float percent = Math.abs(floatX / (float) mRecyclerView.getMeasuredWidth());
                        mRecyclerView.getMeasuredHeight();//当前的高度
//                        snapView.getMeasuredHeight()- mRecyclerView.getMeasuredHeight();
                        Log.e("snapView","snapView:"+snapView.getMeasuredHeight());
                    }
                }
            };
    ...
    void snapToTargetExistingView() {
        ...
        if (snapDistance[0] != 0 || snapDistance[1] != 0) {
            ...
            layoutParams.height = snapView.getMeasuredHeight();
